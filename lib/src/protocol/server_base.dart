...
abstract class BaseServer {
  ...
  FutureOr shutdown();
  FutureOr windowShowMessageRequest(
      ShowMessageRequestParams showMessageRequestParams);
  FutureOr clientUnregisterCapability(
      UnregistrationParams unregistrationParams);
  FutureOr textDocumentWillSaveWaitUntil(
  ...
  FutureOr textDocumentHover(
      TextDocumentPositionParams textDocumentPositionParams);
  FutureOr textDocumentSignatureHelp(
      TextDocumentPositionParams textDocumentPositionParams);
  FutureOr textDocumentDefinition(
      TextDocumentPositionParams textDocumentPositionParams);
  FutureOr textDocumentReferences(ReferenceParams referenceParams);
  FutureOr textDocumentDocumentHighlight(
      TextDocumentPositionParams textDocumentPositionParams);
  FutureOr textDocumentDocumentSymbol(
